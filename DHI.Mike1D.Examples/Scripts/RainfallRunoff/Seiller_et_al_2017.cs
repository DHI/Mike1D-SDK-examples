...
namespace DHI.Mike1D.Catchments.Scripts.RRSeiller
{
  ...
  public class SellierCatchment : Catchment
  {
    ...
    /// </summary>
    public SellierCatchment(string name) : base(name)
    {
      Init();
    }
    ...
    /// </summary>
    public SellierCatchment(string modelId, string name) : base(modelId, name)
    {
      Init();
    }
    ...
    ///</summary>
    public override void Prepare(DateTime simulationStartTime, DateTime simulationEndTime, 
                                 RRParameters rrpars, IDiagnostics diagnostics)
    {
    ...
    {
      if (_boundarySourceRainfall != null)
        _actualRainfall = _boundarySourceRainfall.GetAccumulatedValue(_timeOld, _timeNew) /
  ...
  static class HelperFunctions
  {
    ...
    public static void LoadGlobalParameters(string fileName, out IDictionary<string, string> stringParams,
                                            out IDictionary<string, double> doubleParams)
    {
